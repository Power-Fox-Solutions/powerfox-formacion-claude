...
- **Lo mejor:** Anuncié al grupo que tenemos aprobación para asignar 8 licencias de Claude al equipo durante un mes. El objetivo es demostrar costo-beneficio para extender las licencias. El instructor propuso dedicar una sesión completa a instalar y configurar Claude Code correctamente en cada equipo, incluyendo la estructura de repositorios y los skills de uso diario.
...
- **Lo que me costó:** Coordinar que el resto del equipo configure sus entornos (Python, VS Code, Git) antes de que llegue Cloud Code. Hay dependencias de permisos de TI en algunos equipos.
